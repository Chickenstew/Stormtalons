        ...
        public void Draw()
        {
            ...
            if (config.ShowStormtalonImage)
            {
                if (config.DecayStormtalonImage)
                {
                    ...
                    ImGui.Image(this.stormtalonImage.GetWrapOrEmpty().Handle, new Vector2(imgAdjuster * this.stormtalonImage.GetWrapOrEmpty().Width, this.stormtalonImage.GetWrapOrEmpty().Height), uv0, uv1);
                ...
                {
                    ImGui.Image(this.stormtalonImage.GetWrapOrEmpty().Handle, new Vector2(this.stormtalonImage.GetWrapOrEmpty().Width, this.stormtalonImage.GetWrapOrEmpty().Height));
                }
            }
